...
#if !defined(EXPORTED_VULKAN_FUNCTION)
	#define EXPORTED_VULKAN_FUNCTION(function)
#endif // !EXPORTED_VULKAN_FUNCION

EXPORTED_VULKAN_FUNCTION(vkGetInstanceProcAddr)

#undef EXPORTED_VULKAN_FUNCTION

#if !defined(GLOBAL_LEVEL_VULKAN_FUNCTION)
...
#if !defined(INSTANCE_LEVEL_VULKAN_FUNCTION)
...
#if !defined(INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION)
...
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkCreateWin32SurfaceKHR, VK_KHR_SURFACE_EXTENSION_NAME)
#elif defined(VK_USE_PLATFORM_XCB_KHR)
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkCreateXcbSurfaceKHR, VK_KHR_SURFACE_EXTENSION_NAME)
#elif defined(VK_USE_PLATFORM_XLIB_KHR)
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkCreateXlibSurfaceKHR, VK_KHR_SURFACE_EXTENSION_NAME)
#endif

#undef INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION

#if !defined(INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION)
	#define INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION(function)
#endif // !INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION

INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION(vkEnumerateDeviceExtensionProperties)
INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION(vkGetPhysicalDeviceFeatures)
INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION(vkGetPhysicalDeviceProperties)
INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION(vkGetPhysicalDeviceQueueFamilyProperties)
INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION(vkGetPhysicalDeviceMemoryProperties)
INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION(vkGetPhysicalDeviceFormatProperties)
INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION(vkCreateDevice)

#undef INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION

#if !defined(INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION_FROM_EXTENSION)
	#define INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION_FROM_EXTENSION(function, extension)
#endif // !INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION

INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION_FROM_EXTENSION(
...
#undef INSTANCE_LEVEL_PHYSICAL_DEVICE_VULKAN_FUNCTION_FROM_EXTENSION

#if !defined(INSTANCE_LEVEL_DEVICE_VULKAN_FUNCTION)
	#define INSTANCE_LEVEL_DEVICE_VULKAN_FUNCTION(function)
#endif // !INSTANCE_LEVEL_DEVICE_VULKAN_FUNCTION

INSTANCE_LEVEL_DEVICE_VULKAN_FUNCTION(vkGetDeviceProcAddr)

#undef INSTANCE_LEVEL_DEVICE_VULKAN_FUNCTION

#if !defined(DEVICE_LEVEL_VULKAN_FUNCTION)
...
#if !defined(DEVICE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION)
